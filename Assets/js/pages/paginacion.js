Paginador = function (divPaginador, tabla) {
    this.miDiv = divPaginador; // un DIV donde irán los controles de paginación
    ...
    this.SetPagina = function (num) {
        if (num < 0 || num > this.paginas) return;
        ...
        for (var i = 1; i < this.tabla.rows.length; i++) {
            ...
            else this.tabla.rows[i].style.display = '';
        }
    ...
    this.Mostrar = function () {
        ...
        ant.className = 'pag_btn btn btn-outline-primary'; // con eso le asigno un estilo y una clase al botón
        var self = this;
        ...
        num.innerHTML = ''; // en teoría, aún no se el número de la página
        ...
        if (this.tabla.rows.length - 1 > this.paginas * this.tamPagina) this.paginas = this.paginas + 1;
